...
<body class="pp_body fill">
    <div class="pp_container col-10 mt-5 mb-5">
        <button class="tertiary" onclick="gotoIndex();">back</button>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to PiNK AURA, 4 Orion City, Colombo.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to PiNK AURA, accessible from <a href="pinkaurabydracilla.free.nf" rel="external nofollow noopener" target="_blank">pinkaurabydracilla.free.nf</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: pinkauracosmetics@gmail.com</li>
        </ul>
    </div>
